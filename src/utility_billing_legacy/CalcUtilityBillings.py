...
class CalcUtilityBillings :
    ...
    def getRentRoll(self) :
        ...
        df = pd.read_excel(rrXls, sheet_name="Report1", header=4,  dtype={'Unit':str, 'Unit Type':str, 'Unit.1':str, 'Resident':str, 'Name':str, 'Market':str, 'Actual':str, 'Deposit':str, 'Other_Deposit':str, 'Move In':datetime, 'Lease':datetime, 'Move Out':datetime, 'Balance':str})
    ...
    def getTenantChargeImportDataframe(self, billings_dataframe) :
        ...
        for index, row in billings_dataframe.iterrows() :
            ...
            post_month_str = post_month.strftime('%m/%Y')
